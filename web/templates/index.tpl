...
<link rel="shortcut icon" href="%url%/web/templates/web-gallery/v2/favicon.ico" type="image/vnd.microsoft.icon" />
<link rel="alternate" type="application/rss+xml" title="Habbo Hotel - RSS" href="http://www.habbo.com/articles/rss.xml" />


<link rel="stylesheet" href="%url%/web/templates/web-gallery/static/styles/frontpage.css" type="text/css" />
<script src="%url%/web/templates/web-gallery/static/js/libs2.js" type="text/javascript"></script>
<script src="%url%/web/templates/web-gallery/static/js/landing.js" type="text/javascript"></script>
...
var habboId = null;
var habboReqPath = "";
var habboStaticFilePath = "%url%/web/templates/web-gallery";
...
<meta property="og:title" content="Habbo Hotel - Make friends, join the fun, get noticed!" />
...
<!--[if IE 8]>
<link rel="stylesheet" href="%url%/web/templates/web-gallery/static/styles/ie8.css" type="text/css" />
<![endif]-->
<!--[if lt IE 8]>
<link rel="stylesheet" href="%url%/web/templates/web-gallery/static/styles/ie.css" type="text/css" />
<![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" href="%url%/web/templates/web-gallery/static/styles/ie6.css" type="text/css" />
<script src="%url%/web/templates/web-gallery/static/js/pngfix.js" type="text/javascript"></script>
<script type="text/javascript">
...
<![endif]-->
<meta name="build" content="63-BUILD1804 - 03.12.2012 23:12 - com" />
</head>
...
<div id="rpx-signin">
    <a class="rpxnow" onclick="return false;" href="https://login.habbo.com/openid/v2/signin?token_url=http%3A%2F%2Fwww.habbo.com/rpx">More ways to login</a>
</div>                </div>
...
<div id="fp-container">
    ...
    <div id="column1" class="column">
        ...
        <div id="tagline">Habbo Hotel... make friends, play games, and express yourself</div>
</div>
...
<div id="frontpage-image-container">
    ...
    <div id="join-now-button-container">
        <div id="join-now-button-wrapper">
            <div class="join-now-alternative">
                <a href="%url%/quickregister/start" class="newusers" id="newusers" onclick="startRegistration(this); return false;"><b>New to Habbo?</b><span style="color: #8f8f8f;">Click here to</span></a>
            </div>
    ...
    <div id="people-inside">
        <b><span><span class="stats-fig">%online%</span> user(s) online now</span></b>
        <i></i>
    </div>

    <a href="/quickregister/start" id="frontpage-image" style="background-image: url('%url%/web/templates/web-gallery/v2/images/frontpage/xmas2012_landing.png')" onclick="startRegistration(this); return false;"></a>
...
<div id="footer" class="new_and_improved">
	<p class="footer-links"><a href="http://help.habbo.com">Customer Support</a> l <a href="https://help.habbo.com/forums/144065-information-for-parents">Parents</a> l <a href="https://help.habbo.com/entries/20106178-privacy-policies-terms-of-use" target="_new">Terms of Use & Privacy Policy</a> l <a href="https://help.habbo.com/entries/278050-infringements-policy" target="_new">Infringements</a> l <a href="http://www.habbo.com/safety/habbo_way" target="_new">Habbo Way</a> l <a href="http://www.habbo.com/safety/safety_tips">Safety</a> l <a href="mailto:advertising.com@sulake.com" target="_new">For Advertisers</a></p>
    <div id="age-recommendation"></div>
    <div id="sulake-logo"><a href="http://www.sulake.com"></a></div>
	<p class="copyright">Copyright &copy; Super Hotel 2012 - 2013 - All rights reserved<br /> Powered by SuperCMS</p>
